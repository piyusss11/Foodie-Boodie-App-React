...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="bg-white res-card w-56 h-80 duration-300 hover:cursor-pointer overflow- hover:scale-110 border-black rounded-xl">
      <img
      ...
      <h4 className=" px-3 pt-1 text-sm  text-yellow-400 -white">
        {avgRating} stars
      </h4>
      <h4 className="px-3 pt-1  text-sm ">{slaString} </h4>
    </div>
  );
};
