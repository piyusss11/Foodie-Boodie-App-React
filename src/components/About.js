      ...
      <main className="mx-20 ">
        <section className="mt-12  flex justify-center ">
          <div className=" flex flex-col justify-center">
            ...
            <p>
              Welcome to Foodie Boodie, your go-to destination for delicious
              food delivered right to your doorstep. Founded on the belief that
              great food should be accessible to everyone, we strive to connect
        ...
        <section className="flex mt-12 gap-20 justify-center">
          <div className="border-2 border-black h-80 w-80 rounded-xl shadow-xl flex flex-col items-center px-6 ">
            ...
            <p>
              At Foodie Boodie, our mission is simple: to make food ordering
              easy, convenient, and delightful for everyone. We are committed to
          ...
          <div className="border-2 border-black h-80 w-80 rounded-xl shadow-xl flex flex-col items-center px-6 ">
            ...
            <p>
              ...
              cuisines and dishes from top-rated restaurants in your area.
              Whether you're craving comfort food, exploring new flavors, or
              looking for a quick bite, we've got you covered.
            </p>
          </div>
        </section>
        <section className="mt-20 ">
          <div className="my-8">
            ...
            <ul>
              <li>
                <span className="text-md font-bold">Wide Selection:</span>{" "}
                Choose from a diverse selection of restaurants and cuisines to
                satisfy any craving.
              </li>
              <li>
              ...
              <li>
                ...
                the way, ensuring a hassle-free experience.
              </li>
            </ul>
          </div>
          <div className="my-8">
            ...
            <p>
              ...
              and prioritize environmentally friendly packaging to minimize
              waste.
            </p>
          </div>
          <div>
            ...
            <p>
              ...
              make a positive impact on our communities and enjoy great food
              along the way.
            </p>
          </div>
        </section>
